            ...
            child: Row(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(restaurante.calificacion,
                        style: const TextStyle(
                            color: Colors.black,
                            fontSize: 15,
                            fontWeight: FontWeight.w500)),
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Icon(FontAwesomeIcons.moneyBillAlt,
                      size: 17, color: Colors.greenAccent[400]),
                ),
                Text(restaurante.costoEnvio,
                    style: TextStyle(color: Colors.grey[600])),
                const Padding(
      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              const SizedBox(width: 16),
              Icon(Icons.money, color: Colors.greenAccent[400]),
              Text(' - Shipping cost MXN 22.0',
